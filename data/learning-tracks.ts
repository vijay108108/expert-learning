...
export const learningTracks: LearningTrack[] = [
  {
    ...
    title: "AI",
    slug: "ai",
    description: "Applied AI builder pathways for practical product and automation outcomes.",
    icon: "AI",
    ...
    ctaLabel: "Explore AI Builder Tracks",
  ...
  },
  {
    ...
    title: "Generative AI",
    slug: "genai",
    description: "LLM workflows, RAG pipelines, prompt architecture, and production-grade GenAI engineering.",
    icon: "GAI",
    accentClass: "border-[#C084FC]/30 bg-[#C084FC]/10 text-[#E9D5FF]",
    featuredCourseSlugs: ["generative-ai", "prompt-engineering"],
    ctaLabel: "Explore GenAI Builder Tracks",
  ...
  },
  {
    ...
    title: "Agentic AI",
    slug: "agentic-ai",
    description: "Design, orchestrate, and monitor multi-step AI agent systems with enterprise-ready toolchains.",
    icon: "AG",
    ...
    ctaLabel: "Explore Agentic AI Tracks",
  ...
  },
  {
    ...
    title: "DevSecOps",
    slug: "devsecops",
    description: "Secure CI/CD, cloud hardening, observability, and policy-driven builder delivery pipelines.",
    icon: "DS",
    accentClass: "border-[#34D399]/30 bg-[#34D399]/10 text-[#BBF7D0]",
    featuredCourseSlugs: ["devsecops-foundation", "ci-cd-pipeline-engineering"],
    ctaLabel: "Explore DevSecOps Tracks",
  ...
  },
  {
    ...
    slug: "aws",
    description: "Certification-aligned AWS builder pathways from fundamentals to architecture and DevSecOps.",
    icon: "AWS",
  ...
  },
  {
    ...
    slug: "azure",
    description: "Microsoft-aligned builder paths for administration, AI, architecture, and DevSecOps.",
    icon: "AZ",
    accentClass: "border-[#60A5FA]/30 bg-[#60A5FA]/10 text-[#C8D7EE]",
