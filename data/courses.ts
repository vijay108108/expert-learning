...
function buildCourseData(): Record<CourseCategoryKey, Course[]> {
  const aiCourses: Course[] = [
    createCourse({
      title: "AI Developer Launch Lab Workshop",
      slug: "ai-developer-launch-lab",
      track: "ai",
      category: "ai",
      ...
      mode: "live",
      priceType: "one-time",
      certification: "GenZNext AI Developer Launch Lab Certificate",
      toolsCovered: ["ChatGPT", "GitHub Copilot", "VS Code", "Microsoft Azure", "GitHub", "HTML", "CSS"],
      skillsYouWillLearn: [
        "AI-assisted website development",
        "Azure VM provisioning",
        "Linux server setup basics",
        "Deployment and hosting workflow",
      ],
      learningOutcomes: [
        "Ship a live AI-generated website",
      ...
      syllabusModules: [
        ...
        "Build a website using AI tools",
        "Microsoft Azure VM setup",
        "Deploy website and verify live URL",
        "Career roadmap and next steps",
      ],
      projects: ["Live Azure-hosted workshop project"],
      officialResources: commonOfficialResources,
      youtubeLessons: buildYoutubeLessons("AI Developer Launch Lab Workshop"),
      ...
      tagTone: "orange",
      certificate: "AI Developer Launch Lab Workshop Completion",
      icon: "code",
      tags: ["Workshop", "Azure", "AI", "Live"],
      officialSyllabusUrl: "https://learn.microsoft.com/azure/virtual-machines/",
    }),
    createCourse({
