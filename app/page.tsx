      ...
      <section className="relative overflow-hidden bg-[linear-gradient(160deg,#FFFFFF_0%,#F5F0FF_45%,#E0F2FE_100%)] px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          ...
          <div className="space-y-3">
            ...
            <Link
              href="/enroll/cloud-devops-ai-summer-2026"
            ...
            >
              <div className="min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold text-[#DC2626]">Summer Training 2026</span>
                </div>
                <p className="mt-1.5 text-[13px] font-bold leading-snug !text-[#0F172A]">
                  Cloud, DevOps &amp; AI Engineering Program
                </p>
                ...
                <div className="mt-2 flex flex-wrap items-center gap-3 text-[11px]">
                  ...
                  <span className="rounded-full bg-[#FECACA] px-2 py-0.5 font-bold text-[#DC2626]">67% off</span>
                </div>
              </div>
