    ...
    await Promise.all(
      offerings.map((offering, index) => {
        ...
        return saveEnrollmentRecordAdmin({
          ...
          originalAmount: Math.round((selected.priceValue * 100) / 100),
          discountAmount: Math.round(((selected.priceValue * 100) - (lineItemPaise[index] || 0)) / 100),
          finalPaidAmount: Math.round((lineItemPaise[index] || 0) / 100),
