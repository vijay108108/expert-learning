...
export const programTechStacks: Record<string, TechItem[]> = {
  ...
  "azure-administrator": [
    ...
    { name: "Azure CLI", bg: "#DBEAFE", fg: "#1E40AF" },
    { name: "Entra ID", bg: "#DBEAFE", fg: "#1E3A8A" },
    { name: "RBAC", bg: "#EEF2FF", fg: "#3730A3" },
    { name: "Azure VMs", bg: "#EFF6FF", fg: "#1D4ED8" },
    { name: "VNet", bg: "#DBEAFE", fg: "#1E40AF" },
    { name: "NSG", bg: "#DBEAFE", fg: "#1E3A8A" },
    { name: "Load Balancer", bg: "#EFF6FF", fg: "#2563EB" },
  ...
  "azure-devops-engineer": [
    ...
    { name: "Terraform", bg: "#F5F0FF", fg: "#5B21B6" },
    { name: "Bicep", bg: "#EFF6FF", fg: "#2563EB" },
    { name: "ARM Templates", bg: "#EEF2FF", fg: "#3730A3" },
    { name: "Azure Monitor", bg: "#EFF6FF", fg: "#1D4ED8" },
    { name: "Application Insights", bg: "#EFF6FF", fg: "#1E40AF" },
    { name: "Policy as Code", bg: "#FEF3C7", fg: "#92400E" },
    { name: "Key Vault", bg: "#EFF6FF", fg: "#1E40AF" },
  ...
  "aiops-engineering": [
    ...
    { name: "SRE Practices", bg: "#F5F0FF", fg: "#5B21B6" },
  ],
