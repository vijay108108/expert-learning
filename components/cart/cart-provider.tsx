    ...
    <CartContext.Provider value={value}>
      ...
      <AnimatePresence>
        {toast ? (
          ...
          >
            <div className="pointer-events-auto flex items-center gap-3 rounded-[18px] border border-[#FB923C]/24 bg-[linear-gradient(135deg,rgba(7,20,43,0.96),rgba(11,28,52,0.96))] px-4 py-3 text-sm text-white shadow-[0_18px_36px_rgba(2,8,28,0.32),0_0_22px_rgba(249,115,22,0.12)] backdrop-blur-xl">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[rgba(249,115,22,0.16)] text-[#FDBA74]">
