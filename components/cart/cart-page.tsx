      ...
      <section className="px-4 py-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="surface-form rounded-[28px] px-6 py-10 text-center sm:px-10 sm:py-12">
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-[22px] border border-[#FB923C]/20 bg-[rgba(249,115,22,0.12)] text-[#FDBA74] shadow-[0_18px_36px_rgba(249,115,22,0.12)]">
      ...
      <div className="mx-auto max-w-7xl">
        <div className="surface-form rounded-[28px] p-5 sm:p-6">
          <div className="mb-6 flex flex-col gap-4 border-b border-white/10 pb-5 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <div className="text-[11px] font-medium uppercase tracking-[0.08em] text-[#F97316]">MY CART</div>
            ...
            <div className="shrink-0 rounded-[10px] border border-[rgba(249,115,22,0.3)] bg-[rgba(249,115,22,0.1)] px-4 py-2 text-[14px] font-semibold text-[#F97316]">
              {totalLabel}
            </div>
          </div>
          ...
          <div className="space-y-4">
            {courses.map((course) => {
              ...
              return (
                <article
                  key={course.slug}
                  className="surface-card flex flex-col gap-4 rounded-[22px] border border-white/10 p-4 transition-all duration-200 hover:border-[#FB923C]/30 hover:shadow-[0_16px_34px_rgba(2,8,28,0.22)] sm:flex-row sm:items-start sm:justify-between"
                >
                  <div className="flex min-w-0 gap-4">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-[14px] bg-[rgba(249,115,22,0.14)] text-[#F97316]">
                  ...
                  <div className="flex shrink-0 flex-col items-start gap-3 sm:items-end">
                    <div className="mono-meta text-[18px] font-semibold text-[#FDBA74]">{course.price}</div>
                    <button
                      type="button"
          ...
          <div className="mt-6 flex flex-wrap items-center justify-between gap-4 rounded-[12px] border border-[#1E2D42] bg-[#111827] px-[18px] py-[14px]">
            ...
            <Link
              href="/courses"
              className="inline-flex items-center gap-2 rounded-[8px] border border-[rgba(249,115,22,0.2)] bg-[rgba(249,115,22,0.08)] px-4 py-2 text-sm font-medium text-[#F97316] transition hover:bg-[rgba(249,115,22,0.12)]"
            >
              Explore Courses
          ...
          <Link
            href="/checkout"
            className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-[10px] bg-[#F97316] px-5 py-[13px] text-[15px] font-semibold text-white transition hover:bg-[#EA580C]"
          >
